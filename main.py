...
PORT_NUMBER = int(os.environ.get("gmail_smtp_port"))
...
def contact():
    ...
    if contact_form.validate_on_submit():
        ...
        user_telephone = contact_form.telephone.data
        user_msg = contact_form.message.data

        with SMTP("smtp.gmail.com", port=PORT_NUMBER) as connection:
            connection.starttls()
    ...
    return render_template("contact.html", current_user=current_user, form=contact_form, msg_sent=msg_sent)
